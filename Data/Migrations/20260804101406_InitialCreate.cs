        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaintenanceMessage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ProfessionalTitle = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Location = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EducationRequirement = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CvDocuments_JobSeekerProfiles_JobSeekerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_EmployerId_JobSeekerId_VacancyId_Status",
                table: "ContactRequests",
                columns: new[] { "EmployerId", "JobSeekerId", "VacancyId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CvDocuments_JobSeekerId",
                table: "CvDocuments",
                column: "JobSeekerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_VacancyId_JobSeekerId",
                table: "JobApplications",
